...
func CheckParentSources(c client.Client, tektonController *tekton.TektonController, pr *pipeline.PipelineRun, pipelineBundleName constants.BuildPipelineType) {
...
func CheckSourceImage(srcImage, gitUrl string, pipelineBundleName constants.BuildPipelineType, hub *framework.ControllerHub, pr *pipeline.PipelineRun) {
	...
	CheckParentSources(c, hub.TektonController, pr, pipelineBundleName)
}
